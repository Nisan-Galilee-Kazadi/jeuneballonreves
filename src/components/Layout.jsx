...
const Footer = () => (
    <footer className="bg-[#002244] text-white py-8 px-6 relative overflow-hidden">
        ...
        <motion.div
            ...
            className="absolute -bottom-5 -right-10 opacity-10 pointer-events-none"
        >
            <i className="fas fa-futbol text-[80px] text-white"></i>
        </motion.div>
        ...
        <div className="max-w-6xl mx-auto flex flex-col md:flex-row justify-between items-center gap-8 relative z-10">
            ...
            <div className="text-[10px] font-bold opacity-30 tracking-[0.2em] text-center">
