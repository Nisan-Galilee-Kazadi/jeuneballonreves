    ...
    return (
        ...
        >
            ...
            <div className="relative z-10 self-end">
                <button onClick={() => navigate(path)} className={`${btnColor} text-[10px] font-bold px-5 py-1.5 rounded-sm shadow-md transition-transform hover:scale-105 inline-block cursor-pointer`}>
                    {btnText}
                </button>
            </div>
        </motion.div>
